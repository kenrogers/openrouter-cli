...
```
openrouter O-auth [flags]
```

### Options

```
  -h, --help   help for O-auth
```
...
* [openrouter O-auth create-auth-code](openrouter_O-auth_create-auth-code.md)	 - Create authorization code
* [openrouter O-auth exchange-auth-code-for-API-key](openrouter_O-auth_exchange-auth-code-for-API-key.md)	 - Exchange authorization code for API key
