...
* [openrouter endpoints list](openrouter_endpoints_list.md)	 - List all endpoints for a model
* [openrouter endpoints list-zdr-endpoints](openrouter_endpoints_list-zdr-endpoints.md)	 - Preview the impact of ZDR on the available endpoints
