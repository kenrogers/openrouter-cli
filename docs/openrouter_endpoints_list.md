...
```
openrouter endpoints list [flags]
```

### Examples

```
  openrouter endpoints list --author openai --slug gpt-4
```

### Options

```
  -a, --author string   The author/organization of the model [required]
  -h, --help            help for list
  -s, --slug string     The model slug [required]
```
