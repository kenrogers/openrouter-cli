## openrouter generations list-generation-content
...
```
openrouter generations list-generation-content [flags]
```

### Examples

```
  openrouter generations list-generation-content --id gen-1234567890
```

### Options

```
  -h, --help        help for list-generation-content
  -i, --id string   The generation ID [required]
```
