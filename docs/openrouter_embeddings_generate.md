...
```
openrouter embeddings generate [flags]
```

### Examples

```
  openrouter embeddings generate --input The quick brown fox jumps over the lazy dog --model openai/text-embedding-3-small
```
...
```
  ...
  -e, --encoding-format string   The format of the output embeddings (options: float, base64)
  -h, --help                     help for generate
      --input string             JSON value (one of: string | array of string | array of number | array of array of number | array of { content: value[] })
      --input-type string        The type of input (e.g. search_query, search_document)
  -m, --model string             The model to use for embeddings [required]
  -p, --provider string          JSON object
  -u, --user string              A unique identifier for the end-user
```
