...
```
  -c, --category string               Filter models by use case category (options: programming, roleplay, marketing, marketing/seo, technology, science, translation, legal, finance, health, trivia, academia)
  -h, --help                          help for list
      --output-modalities string      Filter models by output modality. Accepts a comma-separated list of modalities (text, image, audio, embeddings) or "all" to include all models. Defaults to "text".
  -s, --supported-parameters string   Filter models by supported parameter (comma-separated)
```
