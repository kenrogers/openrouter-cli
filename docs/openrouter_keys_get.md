...
```
openrouter keys get [flags]
```

### Examples

```
  openrouter keys get --hash f01d52606dc8f0a8303a7b5cc3fa07109c2e346cec7c0a16b40de462992ce943
```

### Options

```
      --hash string   The hash identifier of the API key to retrieve [required]
  -h, --help          help for get
```
