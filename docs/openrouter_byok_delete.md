...
```
openrouter byok delete [flags]
```

### Examples

```
  openrouter byok delete --id 11111111-2222-3333-4444-555555555555
```
...
```
  ...
  -i, --id string   The BYOK credential ID (UUID). [required]
```
