## openrouter video-generation get-generation
...
```
openrouter video-generation get-generation [flags]
```

### Examples

```
  openrouter video-generation get-generation --job-id job-abc123
```

### Options

```
  -h, --help            help for get-generation
