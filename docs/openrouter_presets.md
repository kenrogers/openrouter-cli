...
* [openrouter presets create-presets-chat-completions](openrouter_presets_create-presets-chat-completions.md)	 - Create a preset from a chat-completions request body
