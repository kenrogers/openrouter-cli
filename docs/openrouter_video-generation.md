...
```
openrouter video-generation [flags]
```

### Options

```
  -h, --help   help for video-generation
```
...
* [openrouter video-generation generate](openrouter_video-generation_generate.md)	 - Submit a video generation request
* [openrouter video-generation get-generation](openrouter_video-generation_get-generation.md)	 - Poll video generation status
* [openrouter video-generation get-video-content](openrouter_video-generation_get-video-content.md)	 - Download generated video content
* [openrouter video-generation list-videos-models](openrouter_video-generation_list-videos-models.md)	 - List all video generation models
