...
* [openrouter embeddings generate](openrouter_embeddings_generate.md)	 - Submit an embedding request
* [openrouter embeddings list-models](openrouter_embeddings_list-models.md)	 - List all embeddings models
