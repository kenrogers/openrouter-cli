...
```
openrouter observability [flags]
```
...
* [openrouter observability create](openrouter_observability_create.md)	 - Create an observability destination
* [openrouter observability delete](openrouter_observability_delete.md)	 - Delete an observability destination
* [openrouter observability get](openrouter_observability_get.md)	 - Get an observability destination
* [openrouter observability list](openrouter_observability_list.md)	 - List observability destinations
* [openrouter observability update](openrouter_observability_update.md)	 - Update an observability destination
