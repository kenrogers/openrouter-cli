...
```
openrouter byok [flags]
```

### Options

```
  -h, --help   help for byok
```
...
* [openrouter byok create](openrouter_byok_create.md)	 - Create a BYOK provider credential
* [openrouter byok delete](openrouter_byok_delete.md)	 - Delete a BYOK provider credential
* [openrouter byok get](openrouter_byok_get.md)	 - Get a BYOK provider credential
* [openrouter byok list](openrouter_byok_list.md)	 - List BYOK provider credentials
* [openrouter byok update](openrouter_byok_update.md)	 - Update a BYOK provider credential
