...
Configure authentication, global parameters, and preferences

### Synopsis

Interactively configure authentication credentials, global parameters, and preferences for the CLI.
