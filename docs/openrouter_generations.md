...
```
openrouter generations [flags]
```

### Options

```
  -h, --help   help for generations
```
...
* [openrouter generations get](openrouter_generations_get.md)	 - Get request & usage metadata for a generation
* [openrouter generations list-generation-content](openrouter_generations_list-generation-content.md)	 - Get stored prompt and completion content for a generation
