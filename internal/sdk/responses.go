...
func (s *Responses) Send(ctx context.Context, request operations.CreateResponsesRequest, opts ...operations.Option) (*operations.CreateResponsesResponse, error) {
	globals := operations.CreateResponsesGlobals{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `text/event-stream`):
			...
			res.ResponsesStreamingResponse = out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
	...
	case httpRes.StatusCode == 408:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out sdkerrors.RequestTimeoutResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
	...
	case httpRes.StatusCode == 413:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out sdkerrors.PayloadTooLargeResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
	...
	case httpRes.StatusCode == 422:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out sdkerrors.UnprocessableEntityResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
