...
func (s *Chat) Send(ctx context.Context, request operations.SendChatCompletionRequestRequest, opts ...operations.Option) (*operations.SendChatCompletionRequestResponse, error) {
	globals := operations.SendChatCompletionRequestGlobals{
