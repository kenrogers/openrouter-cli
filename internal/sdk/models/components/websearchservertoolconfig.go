...
func (w *WebSearchServerToolConfig) UnmarshalJSON(data []byte) error {
...
func (w *WebSearchServerToolConfig) GetAllowedDomains() []string {
	if w == nil {
		return nil
	}
...
func (w *WebSearchServerToolConfig) GetEngine() *WebSearchEngineEnum {
	if w == nil {
		return nil
	}
	return w.Engine
...
func (w *WebSearchServerToolConfig) GetExcludedDomains() []string {
	if w == nil {
		return nil
	}
...
func (w *WebSearchServerToolConfig) GetMaxResults() *int64 {
	if w == nil {
		return nil
	}
	return w.MaxResults
...
func (w *WebSearchServerToolConfig) GetMaxTotalResults() *int64 {
	if w == nil {
		return nil
	}
...
func (w *WebSearchServerToolConfig) GetUserLocation() *WebSearchUserLocationServerTool {
	if w == nil {
		return nil
	}
