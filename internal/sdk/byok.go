...
func (s *Byok) List(ctx context.Context, request *operations.ListBYOKKeysRequest, opts ...operations.Option) (*operations.ListBYOKKeysResponse, error) {
	globals := operations.ListBYOKKeysGlobals{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			if o.SkipDeserialization == nil || !*o.SkipDeserialization {
				...
				var out components.ListBYOKKeysResponse
...
func (s *Byok) Create(ctx context.Context, request operations.CreateBYOKKeyRequest, opts ...operations.Option) (*operations.CreateBYOKKeyResponse, error) {
	globals := operations.CreateBYOKKeyGlobals{
		HTTPReferer:   s.sdkConfiguration.Globals.HTTPReferer,
		AppTitle:      s.sdkConfiguration.Globals.AppTitle,
		AppCategories: s.sdkConfiguration.Globals.AppCategories,
	}
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			if o.SkipDeserialization == nil || !*o.SkipDeserialization {
				...
				var out components.CreateBYOKKeyResponse
				if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
					return nil, err
				}
...
func (s *Byok) Delete(ctx context.Context, request operations.DeleteBYOKKeyRequest, opts ...operations.Option) (*operations.DeleteBYOKKeyResponse, error) {
	globals := operations.DeleteBYOKKeyGlobals{
		HTTPReferer:   s.sdkConfiguration.Globals.HTTPReferer,
		AppTitle:      s.sdkConfiguration.Globals.AppTitle,
		AppCategories: s.sdkConfiguration.Globals.AppCategories,
	}
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/byok/{id}", request, globals)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			if o.SkipDeserialization == nil || !*o.SkipDeserialization {
				...
				var out components.DeleteBYOKKeyResponse
				if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
					return nil, err
				}
...
func (s *Byok) Get(ctx context.Context, request operations.GetBYOKKeyRequest, opts ...operations.Option) (*operations.GetBYOKKeyResponse, error) {
	globals := operations.GetBYOKKeyGlobals{
		HTTPReferer:   s.sdkConfiguration.Globals.HTTPReferer,
		AppTitle:      s.sdkConfiguration.Globals.AppTitle,
		AppCategories: s.sdkConfiguration.Globals.AppCategories,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			if o.SkipDeserialization == nil || !*o.SkipDeserialization {
				...
				var out components.GetBYOKKeyResponse
				if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
					return nil, err
				}
...
func (s *Byok) Update(ctx context.Context, request operations.UpdateBYOKKeyRequest, opts ...operations.Option) (*operations.UpdateBYOKKeyResponse, error) {
	globals := operations.UpdateBYOKKeyGlobals{
		HTTPReferer:   s.sdkConfiguration.Globals.HTTPReferer,
		AppTitle:      s.sdkConfiguration.Globals.AppTitle,
		AppCategories: s.sdkConfiguration.Globals.AppCategories,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			if o.SkipDeserialization == nil || !*o.SkipDeserialization {
				...
				var out components.UpdateBYOKKeyResponse
				if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
					return nil, err
				}
