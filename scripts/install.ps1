#
# openrouter CLI Installation Script for Windows
...
#   or
#   Invoke-WebRequest -Uri https://raw.githubusercontent.com/kenrogers/openrouter-cli/main/scripts/install.ps1 -UseBasicParsing | Invoke-Expression
#
# Options:
#   $env:OPENROUTER_INSTALL_DIR - Installation directory (default: $env:LOCALAPPDATA\Programs\openrouter)
#   $env:OPENROUTER_VERSION     - Specific version to install (default: latest)
#
...
function Install-CLI {
    Write-ColorOutput "Installing openrouter CLI..." -Color Green
    ...
    $tempDir = Join-Path $env:TEMP "openrouter-install-$(New-Guid)"
    ...
    try {
        ...
        Write-ColorOutput "openrouter $Version has been installed to $binaryPath" -Color Green
